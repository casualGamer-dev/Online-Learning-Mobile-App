...
const ExamDialog = (props: any) => {
    const {visible, setVisible, loading, setLoading, subject_details, getParticularCourseDetails} = props;
            ...
            .then(() => {
                ...
                Alert.alert('Success','Exam Question Uploaded!', 
                    [
                        {
                            text: "DONE",
                            onPress: () => getParticularCourseDetails(),
                            style: "cancel"
                        }
                    ],
                    { cancelable: false }
                ...
                <Dialog.Title>Take an Exam</Dialog.Title>
                    <Dialog.Content>
                        <View>
                            ...
                            />
                            <TextInput 
                                label={'Start Time(HH-MM-SS 24HRS)'}
                                onChangeText={(date) => setStartDate(date)}
                                value={startDate}
                                style={styles.textInputStyle}
                            />
                            <TextInput 
                                label={'Submission Time(HH-MM-SS 24HRS)'}
