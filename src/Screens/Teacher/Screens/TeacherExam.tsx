...
import ExamBlockCard from './components/ExamBlockCard';
import Loader from '../../../components/Loader';
const {width, height} = Dimensions.get('screen');

export const TeacherExam = ({route, navigation}: any) => {
    ...
    const getParticularCourseDetails = async () => {
        ...
        try{
            ...
            fullSubjectDetails.forEach((res: any) => {
                const { file_name, details, file_url, published_on, start_time, end_time, exam_id } = res.data();
                    ...
                    <View style={styles.categoryBody}>
                        ...
                        <View style={styles.materialContent}>
                            <View style={styles.uploadSection}>
                                <Text style={styles.uploadText}>Want to Take Exam ? </Text>
                        ...
                        {empty ?
                            <View style={styles.zeroQuestion}>
                                ...
                                <Text>If you have uploaded any Exam, Please reopen the tab!</Text>
                            </View>
                        :
                        <FlatList 
