...
import { QuestionAnswer, StudentAssignment, StudentLiveClass, StudentSeperateExam } from '../../src/Screens/Student';
...
const StudentMainNavigator = () => {
    return(
        <StudentStack.Navigator
            ...
            <StudentStack.Screen name="StudentLiveClassNow" component={StudentLiveClass} /> 
            <StudentStack.Screen name="ChatBot" component={MainChatBot} />
